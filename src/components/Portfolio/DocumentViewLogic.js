...
const initialFields = {
    name: "",
    description: "",
    category: [], // ["medical", "wireless"]
    operationtype: 2, // "" || "summary" || "timeline" || "flowchart"
...
export function DocumentViewLogic(props){
    ...
    const handleRun = async() => {
        const response = await Api.getTranslationConditionalBlockByDocumentId(props.document[0].documentid);
        // if (!response) return setRedirect(true);
        const summary = response._json;
        console.log("Result of reprocessDocument",summary)
                                        ...
                                        <div className={classes.formContainer}>
                                            ...
                                            <FormControl>
                                                <Select value={model}
                                                    ...
                                                    <MenuItem value="Logic Translation">Logic Translation</MenuItem>
                                                </Select>
                                            </FormControl>
                                            <div></div>
                                            <div></div>
...
export default connect(mapStateToProps)(DocumentViewLogic);
