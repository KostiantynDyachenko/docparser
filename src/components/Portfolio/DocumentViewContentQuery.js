...
export function DocumentViewContentQuery(props){
    ...
    const [QAOperation, setQAOperation] = useState("Q/A ENGINE");
    ...
    const changeQAOperation = (event) => {
        setQAOperation(event.target.value)
    }
    ...
    const handleRun = async() => {
        ...
        if(!question) return; //if user didn`t entered question, he can`t click run button

        const body = {
            compare_document_list: props.document.map(row => row.documentid),
            is_long_form: true,
            question: question
        }
        console.log("body", body);

        const response = await Api.getQuestionAnswered(body);
                                ...
                                <div className={classes.contextcontent}>
                                    <div className={classes.verticalFlexContainer}>
                                        <div className={classes.formContainer}>
                                            <Button onClick={handleRun}>RUN<PlayArrow/></Button>
                                            <FormControl>
                                                <Select value={QAOperation}
                                                        onChange={changeQAOperation}
                                                        labelId="select-label">
                                                    <MenuItem value="Q/A ENGINE" disabled>Q/A ENGINE</MenuItem>
                                                    <MenuItem value="Q/A">Q/A</MenuItem>
                                                    <MenuItem value="AI Q/A">AI Q/A</MenuItem>
                                                    <MenuItem value="Phrase Search">Phrase Search</MenuItem>
                                                </Select>
                                            </FormControl>
                                            <div></div>
                                            <div></div>
                                        </div>
                                        <div className={classes.inputQuestionContainer}>
                                            <TextareaAutosize className={classes.inputQuestionTextArea}
                                    ...
                                    <div className={classes.verticalFlexContainer}>
                                        ...
                                        <div className={classes.inputQuestionContainer}>
                                            <TextareaAutosize minRows={5}
                                                              className={classes.inputQuestionTextArea}
                                                              placeholder="Question..."
                                                              value={question}
                                                              onChange={changeQuestion}
                                            />
...
export default connect(mapStateToProps)(DocumentViewContentQuery);
