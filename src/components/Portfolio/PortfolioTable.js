...
function PortfolioTable(props) {
    ...
    const rowDoubleClick = (event) => {
        // event.dataItem
        props.handleDblClick(event.dataItem);
    }
    ...
    const rowClick = (event) => {
        ...
        props.changeSelectedFiles(_data);
    ...
    const selectionChange = (event) => {
        ...
        props.changeSelectedFiles(data);
            ...
            >
                <Column
                    ...
                    headerSelectionValue={
                        (props.data.every(dataItem => dataItem.selected === true) && (props.data.length > 0))
                    } />
